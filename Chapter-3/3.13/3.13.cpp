...
int main() {
	...
	if (status == 0) {
		...
		if (income <= 8350)
			...
			tax = 8350 * 0.10 + (33960 - 8350) * 0.15 + (income - 33960) * 0.25;
		else if (income <= 104425)
			tax = 8350 * 0.10 + (33960 - 8350) * 0.15 + (68525 - 33960) * 0.25
			+ (income - 68525) * 0.28;
		...
		if (income <= 11950)
			...
			tax = 11950 * 0.10 + (45500 - 11950) * 0.15 + (income - 45500) * .025;
		else if (income <= 190200)
			tax = 11950 * 0.10 + (45500 - 11950) * 0.15 + (117450 - 45500) * .025
			+ (income - 117450) * 0.28;
		else if (income <= 372950)
			tax = 11950 * 0.10 + (45500 - 11950) * 0.15 + (117450 - 45500) * .025
	...
	cout << "Tax is $" << static_cast<int>(tax * 100) / 100.00 << endl;
